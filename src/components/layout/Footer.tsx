      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center sm:text-left">
            <p className="text-sm font-medium text-white/50">我的智囊</p>
            <p className="text-xs text-white/20 mt-0.5">思维框架模拟工具，非任何人物授权</p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-xs text-white/30">
            ...
            <Link href="/history" className="hover:text-white/60 transition-colors">
              历史记录
            </Link>
            <a
        ...
        {/* Legal note */}
        <p className="text-center text-xs text-white/15 mt-6 leading-relaxed max-w-2xl mx-auto">
