        ...
        <div className="text-center max-w-md">
          ...
          <div className="flex justify-center gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 border border-[#dcc1b8] text-[#56423c] text-sm rounded-xl hover:text-[#9a4021] hover:border-[#9a4021] transition-all"
            >
              🔍 去质疑团
            </button>
            <button
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
                    ...
                    {EMOJI_OPTIONS.map(e => (
                      <button
                        ...
                        className={`w-9 h-9 rounded-lg text-xl flex items-center justify-center transition-all ${
                          skillEmoji === e
                            ? 'bg-[#9a4021] border border-[#9a4021] text-white'
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-2.5 border border-[#dcc1b8] text-[#56423c] text-sm rounded-xl hover:text-[#9a4021] hover:border-[#9a4021] transition-all"
                >
                  重新生成
                </button>
                <button
            ...
            <div className="rounded-2xl border border-[#dcc1b8]/40 bg-[#efeee7] p-5">
              ...
              <textarea
                ...
                rows={20}
                className="w-full bg-white text-xs text-[#1b1c18] font-mono resize-none focus:outline-none focus:border focus:border-[#9a4021] leading-relaxed rounded-lg px-3 py-2 border border-[#dcc1b8]"
              />
            </div>
          </div>
        </div>
            ...
            <div className="flex gap-1 p-1 bg-[#fbf9f2] rounded-xl w-fit">
              <button
                ...
                className={`px-4 py-1.5 rounded-lg text-sm transition-all ${
                  inputMode === 'text' ? 'bg-[#9a4021] text-white' : 'text-[#89726b] hover:text-[#56423c]'
                }`}
              >
                粘贴文本
              </button>
              <button
                ...
                className={`px-4 py-1.5 rounded-lg text-sm transition-all ${
                  inputMode === 'url' ? 'bg-[#9a4021] text-white' : 'text-[#89726b] hover:text-[#56423c]'
                }`}
              >
                网页链接
              </button>
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-white border border-[#dcc1b8] rounded-xl px-4 py-2.5 text-sm text-[#1b1c18] placeholder-[#89726b] focus:outline-none focus:border-[#9a4021] transition-colors"
                  />
                  <button
                    onClick={fetchUrl}
