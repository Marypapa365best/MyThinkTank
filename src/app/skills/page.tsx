    ...
    <div className="min-h-screen">
      ...
      <div className="bg-[#fbf9f2] pt-32 pb-12 px-8 lg:px-16 border-b border-[#dcc1b8]/40">
        <div className="max-w-screen-xl mx-auto">
          <p className="label-overline text-[#d97757] mb-4">智囊库</p>
              ...
              <button
                ...
                className={`px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-300 border ${
                  activeCategory === cat.value
                    ...
                    : 'border-[#dcc1b8] text-[#56423c] bg-[#fbf9f2] hover:border-[#d97757] hover:text-[#d97757] hover:bg-white hover:shadow-sm'
                }`}
              >
                {cat.label}
              </button>
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5 mb-5">
                  {skill.tags.slice(0, 3).map(tag => (
                    <span key={tag} className="text-xs px-2.5 py-0.5 rounded-full bg-[#efeee7] text-[#89726b] group-hover:bg-[#d97757]/10 group-hover:text-[#d97757] transition-colors">
                      {tag}
                    </span>
                  ))}
                </div>
