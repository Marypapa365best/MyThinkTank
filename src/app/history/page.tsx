          ...
          {sessions.length > 0 && (
            <div className="flex items-center gap-3">
              <button
                ...
                className="text-xs text-[#1b1c18]/40 hover:text-[#1b1c18] transition-colors px-3 py-1.5 border border-[#dcc1b8] rounded-lg hover:border-[#d97757]/25"
              >
                ↓ 全部导出 .md
              </button>
              <button
              ...
              >
                ...
                <div className="flex items-center gap-2 ml-2 shrink-0">
                  <button
                    ...
                    className="text-[#1b1c18]/25 hover:text-[#56423c] text-xs transition-colors px-1.5 py-0.5 rounded border border-[#dcc1b8] hover:border-[#d97757]/25"
                    title="下载 Markdown"
                  >
                    .md
                  </button>
