    ...
    <div className="min-h-screen">
      ...
      <div className="bg-[#fbf9f2] pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs text-[#d97757] mb-4 tracking-wider uppercase font-medium">定价方案</p>
          <h1
              ...
              >
                {plan.badge && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="bg-[#d97757] text-white text-xs font-medium px-4 py-1.5 rounded-full shadow-sm">
                      ⭐ {plan.badge}
                    </span>
                  </div>
                )}
                ...
                <Link
                  ...
                  className={`block text-center py-3 rounded-xl text-sm font-medium transition-all mb-6 ${
                    plan.highlight
                      ? 'bg-[#d97757] text-white hover:bg-[#d97757]/90 shadow-sm'
                      : 'border border-[#dcc1b8] text-[#56423c] hover:text-[#d97757] hover:border-[#d97757] hover:bg-[#fbf9f2]'
                  }`}
                >
                  {plan.cta}
                </Link>
                  ...
                  {plan.features.map((f) => (
                    <li key={f.text} className="flex items-start gap-2.5 text-sm">
                      <span className={`mt-0.5 flex-none text-base leading-none ${
                        f.included
                          ? plan.highlight ? 'text-[#d97757]' : 'text-[#d97757]'
      ...
      <div className="bg-[#fbf9f2] py-24 px-4">
        <div className="max-w-2xl mx-auto">
          <p className="text-xs text-[#d97757] mb-4 tracking-wider uppercase font-medium text-center">FAQ</p>
          <h2
        ...
        <div className="text-center mt-20">
          ...
          <a
            ...
            className="text-[#d97757] hover:text-[#d97757]/80 text-sm font-medium underline underline-offset-4 transition-colors"
          >
            📧 发邮件给我们
          </a>
        </div>
